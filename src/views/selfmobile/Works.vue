      ...
      <iCol>
        ...
        >
          <Row>
            <i-col span="21">
              ...
              <Icon
                ...
                @click="jumpEditArticle(article.id)"
          ...
          <div id="warning">
            ...
            <strong>警告：</strong>
            <span v-for="(str,i) in article.article_warning.split(',')" :key="i">
          ...
          <div id="relationship">
            ...
            <span v-for="(str,index) in article.article_relationship.split(',')" :key="index">
...
export default {
  ...
  methods: {
    getMyFamdom(offset, amount) {
      ...
      this.$axios
        .get(`/api/user/${this.$route.params.uid}/articles`, {
          params: {
            offset: offset,
            amount: amount
          }
