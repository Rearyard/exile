export default {
  ...
  registerPage: {
    ...
    emailVerificationDesc: '我们已向您的邮箱发送了一封验证邮件，请查收并点击链接完成验证。',
  },
  emailVerificationPage: {
    title: '验证你的邮箱',
    desc: '我们已向你的注册邮箱 {0} 发送了一封验证邮件，请查收并点击链接完成验证。或在下方输入邮件中的 6 位验证码。如果你没有收到邮件，请检查你的垃圾邮件或其他文件夹。',
    resendEmail: '我没有收到邮件，重新发送',
    validationError: '验证码错误，请检查后重试',
